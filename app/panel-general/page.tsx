...
import { Instagram, Facebook, BarChart3, Share2, TrendingUp as TrendingUpIcon, User, ExternalLink, Home, Info } from "lucide-react"
...
export default function PanelGeneralPage() {
  ...
  const agentId = "2" // Fixed agent ID for general panel
          ...
          <Tabs defaultValue="informacion" className="w-full">
            <div className="flex items-center justify-between gap-4">
              <TabsList className="inline-flex h-10 items-center justify-start gap-1 rounded-lg bg-muted p-1">
                <TabsTrigger value="informacion" className="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm font-medium">
            ...
            <TabsContent value="informacion" className="mt-6 space-y-6">
              <Card className="w-full overflow-hidden">
                <CardHeader>
                  <CardTitle>Datos de Conexión de Facebook</CardTitle>
                  <CardDescription>
                    Toda la información obtenida de la conexión con Facebook/Instagram
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-4">
                  {facebookData ? (
                    <div className="rounded-lg bg-muted p-4 overflow-auto max-h-[600px]" style={{ maxWidth: '100%' }}>
                      <pre className="text-xs font-mono whitespace-pre-wrap" style={{ wordBreak: 'break-all', overflowWrap: 'anywhere' }}>
